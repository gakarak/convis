...
% Last Modified by GUIDE v2.5 31-Oct-2008 00:47:24
...
% %         handles.vid_sf_siz(1):handles.vid_sf_siz(1)+handles.vid_sf_siz(3),3);
    ...
    if get(handles.checkVxVy,'Value')
        ...
        set(handles.textVx1,'String',[num2str(vx,'%10.1f'),' dps']);
        set(handles.textVx3,'String',[num2str(sum(handles.vxvy3(:,1)),'%10.1f'),' dps']);
        set(handles.textVy1,'String',[num2str(vy,'%10.1f'),' dps']);
        set(handles.textVy3,'String',[num2str(sum(handles.vxvy3(:,2)),'%10.1f'),' dps']);
    end
